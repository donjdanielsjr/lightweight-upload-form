...
require_once LUF_PLUGIN_PATH . 'includes/updater/class-oft-plugin-updater.php';
...
new OFT_Plugin_Updater(
	array(
		...
		'plugin_slug'  => 'lightweight-upload-form',
		'plugin_name'  => 'Lightweight Upload Form',
		'metadata_url' => 'https://onefeaturetrap.com/plugin-downloads/lightweight-upload-form.json',
	)
);
